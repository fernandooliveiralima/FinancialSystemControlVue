        ...
        <section class="all-transactions">
            ...
            <section class="current-balance-section">
                <div class="current-balance">
                    ...
                    <strong class="strong-current-balance">{{ formatedValues.formatValues(updateValues().Total.value)
                    }}</strong>
                </div>
            ...
            <section class="income-section">
                <div class="income">
                    ...
                    <strong class="strong-income-section"> {{ formatedValues.formatValues(updateValues().income.value)
                    }}</strong>
                </div>
            ...
            <section class="expense-section">
                <div class="expense">
                    ...
                    <strong class="strong-expense-section"> {{ formatedValues.formatValues(updateValues().expense.value)
                    }}</strong>
                </div>
